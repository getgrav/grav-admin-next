/**
 * Resolve a Grav plugin icon name to FA7 CSS classes.
 *
 * Grav plugins store icons as bare names (e.g. "empire", "plug", "envelope").
 * Many legacy plugins still use FA4-era names (with "-o" suffixes or old names)
 * that were removed/renamed in FA6+. We use the official FA v4-shims mapping
 * to translate these to their modern FA7 equivalents with the correct family.
 */

type FAFamily = 's' | 'r' | 'b'; // solid, regular, brands
...
/** Icons that are in the brands family (after shim resolution). */
const FA_BRAND_ICONS = new Set([
	'500px', 'accessible-icon', 'adn', 'amazon', 'android', 'angellist', 'apple',
	'aws', 'bandcamp', 'behance', 'bitbucket', 'bitcoin', 'black-tie', 'bluetooth',
	'bluetooth-b', 'btc', 'buysellads', 'cc-amex', 'cc-diners-club', 'cc-discover',
	'cc-jcb', 'cc-mastercard', 'cc-paypal', 'cc-stripe', 'cc-visa', 'chrome',
	'cloudflare', 'codepen', 'codiepie', 'connectdevelop', 'contao',
	'creative-commons', 'css3', 'dashcube', 'delicious', 'deviantart',
	'digg', 'digital-ocean', 'discord', 'docker', 'dribbble', 'dropbox',
	'drupal', 'edge', 'empire', 'envira', 'ethereum', 'etsy', 'expeditedssl',
	'facebook', 'facebook-f', 'firefox', 'flickr', 'font-awesome', 'fonticons',
	'fort-awesome', 'foursquare', 'free-code-camp', 'get-pocket', 'gg',
	'gg-circle', 'git', 'github', 'github-alt', 'gitlab', 'glide', 'glide-g',
	'google', 'google-plus', 'google-plus-g', 'google-wallet', 'gratipay',
	'grav', 'hacker-news', 'houzz', 'html5', 'imdb', 'instagram',
	'internet-explorer', 'ioxhost', 'java', 'joomla', 'js', 'jsfiddle',
	'laravel', 'lastfm', 'leanpub', 'linkedin', 'linkedin-in', 'linode',
	'linux', 'magento', 'maxcdn', 'medium', 'meetup', 'mixcloud', 'modx',
	'node-js', 'npm', 'odnoklassniki', 'opencart', 'openid', 'opera',
	'optin-monster', 'pagelines', 'paypal', 'php', 'pied-piper',
	'pied-piper-alt', 'pied-piper-pp', 'pinterest', 'pinterest-p',
	'product-hunt', 'python', 'qq', 'quora', 'ravelry', 'rebel', 'reddit',
	'reddit-alien', 'renren', 'safari', 'scribd', 'sellcast', 'sellsy',
	'shirtsinbulk', 'shopify', 'simplybuilt', 'skyatlas', 'skype', 'slack',
	'slideshare', 'snapchat', 'soundcloud', 'spotify', 'square-behance',
	'square-facebook', 'square-git', 'square-github', 'square-google-plus',
	'square-lastfm', 'square-odnoklassniki', 'square-pinterest',
	'square-reddit', 'square-snapchat', 'square-steam', 'square-tumblr',
	'square-twitter', 'square-viadeo', 'square-vimeo', 'square-xing',
	'square-youtube', 'stack-exchange', 'stack-overflow', 'steam',
	'stripe', 'stumbleupon', 'stumbleupon-circle', 'superpowers',
	'symfony', 'telegram', 'tencent-weibo', 'themeisle', 'trello', 'tumblr',
	'twitch', 'twitter', 'usb', 'viacoin', 'viadeo', 'vimeo-v', 'vine',
	'vk', 'weibo', 'weixin', 'whatsapp', 'windows', 'wordpress',
	'wpbeginner', 'wpexplorer', 'wpforms', 'xing', 'y-combinator',
	'yahoo', 'yelp', 'yoast', 'youtube',
]);

const FAMILY_PREFIX: Record<FAFamily, string> = {
	's': 'fa-solid',
	'r': 'fa-regular',
	'b': 'fa-brands',
};
